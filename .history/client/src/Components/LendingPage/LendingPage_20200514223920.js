  ...
  return <div>
      ...
      <Container>
          <div style={{textAlign:"center"}}>
            <br/>
            <hr/>
            <h3>Trouve ton Immobilier sans the deplacer</h3>
            <hr/>
          </div>
        <br/>
                  ...
                  <Col sm={12}>
                    ...
                    <div key={immobilier._id} >
                      <Row style={{borderTop:"3px double #000", paddingTop:"10px"}}>
                        ...
                        <Col sm={4} style={{textAlign:"left",background:"#DCDCDC", paddingTop:"10px"}}>
                            ...
                            <p> <strong>Email:</strong> {immobilier.immobilier? ` ${immobilier.sellerEmail}` : ""}</p>  
                            {/* <a href = "taylor.dev25@taytay.com?subject = Feedback&body = Message">{immobilier.sellerEmail}</a>                                                                                              */}
                            <a href="mailto:taylot.dev25@gmail.com?subject=The%20subject&body=This%20is%20a%20message%20body">Send mail</a>
